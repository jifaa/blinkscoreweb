    ...
    <div className="min-h-screen flex flex-col bg-background">
      ...
      <nav className="h-14 flex items-center justify-between px-6 border-b border-border">
        <div className="flex items-center gap-2">
          ...
          <span className="font-semibold text-foreground">BlinkScore</span>
        </div>
      ...
      {/* Hero Section */}
      <section className="flex-1 flex items-center justify-center py-24 px-6 bg-background">
        <div className="max-w-4xl mx-auto text-center">
          {/* Eyebrow */}
          <div className="inline-flex items-center gap-2 px-3 py-1.5 rounded-sm bg-secondary border border-border text-muted-foreground text-xs font-medium mb-6">
      ...
      <section id="features" className="py-16 px-6 border-t border-border">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
            <h2 className="text-2xl font-semibold text-foreground mb-2">Built for Performers</h2>
          ...
          <div className="grid md:grid-cols-3 gap-5">
            ...
            <div className="bg-card border border-border rounded-lg p-5">
              <div className="w-9 h-9 bg-primary/10 rounded-sm flex items-center justify-center mb-4">
                <Eye className="w-4 h-4 text-primary" />
              </div>
              <h3 className="text-base font-medium text-foreground mb-1.5">Natural Winks</h3>
            ...
            <div className="bg-card border border-border rounded-lg p-5">
              ...
              <h3 className="text-base font-medium text-foreground mb-1.5">100% Private</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
            ...
            <div className="bg-card border border-border rounded-lg p-5">
              ...
              <h3 className="text-base font-medium text-foreground mb-1.5">Stage Ready</h3>
              <p className="text-sm text-muted-foreground leading-relaxed">
      ...
      <section id="how-it-works" className="py-16 px-6 border-t border-border bg-background">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-10">
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center">
              <div className="w-12 h-12 bg-primary rounded-sm flex items-center justify-center mx-auto mb-5 text-primary-foreground font-semibold text-lg">
                1
              </div>
              <h3 className="text-base font-medium text-foreground mb-2">Upload Your Score</h3>
            ...
            <div className="text-center">
              ...
              <h3 className="text-base font-medium text-foreground mb-2">Calibrate Once</h3>
              <p className="text-muted-foreground">
            ...
            <div className="text-center">
              ...
              <h3 className="text-base font-medium text-foreground mb-2">Perform</h3>
              <p className="text-muted-foreground">
      ...
      {/* Use Cases Section */}
      <section id="use-cases" className="py-16 px-6 border-t border-border bg-background">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-8">
            <h2 className="text-2xl font-semibold text-foreground mb-2">Perfect For</h2>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-4">
            <div className="flex items-start gap-4 p-5 bg-card border border-border rounded-lg">
              ...
              <div>
                <h3 className="text-base font-medium text-foreground mb-1">Pianists & Organists</h3>
            ...
            <div className="flex items-start gap-4 p-5 bg-card border border-border rounded-lg">
              ...
              <div>
                <h3 className="text-base font-medium text-foreground mb-1">Multi-tasking Musicians</h3>
                <p className="text-sm text-muted-foreground">
            ...
            <div className="flex items-start gap-4 p-5 bg-card border border-border rounded-lg">
              ...
              <div>
                <h3 className="text-base font-medium text-foreground mb-1">Privacy-Conscious</h3>
                <p className="text-sm text-muted-foreground">
            ...
            <div className="flex items-start gap-4 p-5 bg-card border border-border rounded-lg">
              ...
              <div>
                <h3 className="text-base font-medium text-foreground mb-1">Live Performers</h3>
                <p className="text-sm text-muted-foreground">
      ...
      <section className="py-12 px-6 border-t border-border bg-secondary">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-2xl font-semibold text-foreground mb-2">Always Have Control</h2>
          ...
          <div className="flex items-center justify-center gap-8">
            ...
            <div className="flex items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">Edge Click</span>
            </div>
            <div className="flex items-center gap-3">
              <Eye className="w-5 h-5 text-primary" />
              <span className="text-sm text-muted-foreground">Eye Winks</span>
            </div>
          </div>
        </div>
      </section>
      ...
      <footer className="border-t border-border py-8 px-6 bg-background">
        <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
          <div className="flex items-center gap-2">
            <Eye className="w-4 h-4 text-primary" />
            <span className="text-sm font-medium text-foreground">BlinkScore</span>
          </div>
